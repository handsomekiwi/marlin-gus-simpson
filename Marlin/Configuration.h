...
#define CUSTOM_MACHINE_NAME "KIWI SIMPSON"
...
// GUS
  ...
  #define HUB_Z 95//++ z up x y down z0 down
  #define SHOULDER_Z 0.0
  #define HOMED_HEIGHT 169
  #define GUS_PROBEABLE_RADIUS 40 //auto level need to rewrite
  #define GUSX 78.1194
  #define GUSY 77.8458
  #define GUSZ 78.9978
  #define GUSE 90
...
//------------------------------------------------------------------------------
  ...
  #define DELTA_DIAGONAL_ROD 250.0 // mm                      DO

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 175.0 // mm                NOT

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 33.0 // mm

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 18.0 // mm                    USE
//------------------------------------------------------------------------------
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID  // Deltas only support grid mode.
    ...
    #define DELTA_PROBEABLE_RADIUS GUS_PROBEABLE_RADIUS
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {GUSX, GUSY, GUSZ,GUSE} 
...
#define SERVO_ENDSTOP_ANGLES {{0,0}, {0,0}, {50,10}} // X,Y,Z Axis Extend and Retract angles
